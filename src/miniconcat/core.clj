...
(register-words-for-clj-fns
 ...
 :range1  1   range   "Creates a range from 0 to the top item:\n  (3 :range1 ...) -> ((0 1 2) ...)"
 :range2  2   range   "Creates a range from top to 2nd item:\n  (1 3 :range2 ...) -> ((1 2) ...)"
 :range3  3   range   "Creates a range from top to 2nd item, stepping by 3rd item:\n  (1 10 3 :range3 ...) -> ((1 4 7) ...)"
